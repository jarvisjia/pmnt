...
任务步骤
    ...
    图片访问地址：
    https://blush-neat-pony-974.mypinata.cloud/ipfs/bafybeigpkcg3mt4uuwarma7ipetc2pdg22wclmgptqcpp7teza3koern4e
    元数据访问地址；
    https://blush-neat-pony-974.mypinata.cloud/ipfs/bafkreiazg3pua5rfht3qaajgvujflglhnh3q2q5ecx2o3vbfm2sb2nucjy
...
contract MyNFT is ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("MyNFT", "MTNFT") Ownable(msg.sender) {
        _tokenIdNo = 1;
    }

    function mintNFT(address recipient, string memory tokenURI) public onlyOwner returns (uint256) {
        uint256 tokenIdNo = _tokenIdNo++;
        _safeMint(recipient, tokenIdNo);
        _setTokenURI(tokenIdNo, tokenURI);
        return tokenIdNo;
    }

    //重写{tokenURI}的基础URI 
    function _baseURI()internal pure override returns (string memory) {
        return "https://blush-neat-pony-974.mypinata.cloud/ipfs/";
    }
}